...
<div class="container-fluid">	
	<div class="wrapper">
		...
		<div class="row" style="margin-top: 60px;">
			...
			<div class="col-md-2">
				<div class="advertisement">
					<%-- <img src="<c:url value="/views/images/add-5.jpg"/>" width="100%" height="100%"/>
					<img src="<c:url value="/views/images/add-6.jpg"/>" width="100%" height="100%"/>
					<img src="<c:url value="/views/images/add-7.jpg"/>" width="100%" height="100%"/>
					<img src="<c:url value="/views/images/add-8.png"/>" width="100%" height="100%"/> --%>
				</div>
			</div>
    	</div>
</div>
